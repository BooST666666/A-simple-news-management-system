			...
			<div class="nav-bar">
				...
				<div class="navigation">
					<div class="nav-items">
						...
						<a href="#"><i class="ri-search-line"></i>搜索</a>
...
而现今，动漫的发展已属于文化创意产业，同时是目前全世界热门且高人气的流行文化。</p>
		...
		// $row = mysqli_fetch_object($newsRes1);
		// if(!$newsRes1){
		// 	echo "<script>alert('搜索的信息不存在!'); window.location.href = 'find.php';</script>";
		// }

		while($news = mysqli_fetch_array($newsRes1)){
			echo
			"<li>
			<span>$news[6]</span>
			<a href='$news[7]".$news[0]."'>$news[3]</a>
			</li>";
		}
