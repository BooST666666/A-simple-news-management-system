			...
			<div class="blog_list_wrap">
                ...
                <table class="table1">
					...
					<tr>
                        ...
                        <td align="center"><a href="modify.php?id=<?php echo $row->news_id;?>&&title=<?php echo $row->title;?>&&catagory_id=<?php echo $row->catagory_id ?>"><img src="image/edit-fill.png" style="width: 30;height:30; border:0;"></a></td>
                      ...
                      <table style="width:100%; font-size:14px; border:0px;">
                        <tr>
                          <!--  翻页条 -->
							...
							echo  "<a href=update_news.php?page=1 >首页</a>&nbsp;";        //显示“首页”超链接
							echo "<a href=update_news.php?page=".($_GET['page']-1).">上一页</a>&nbsp;";      //显示“上一页”超链接
							}
							if($_GET['page']<$page_count){                                  //如果当前页不是尾页
							echo "<a href=update_news.php?page=".($_GET['page']+1).">下一页</a>&nbsp;";       //显示“下一页”超链接
							echo "<a href=update_news.php?page=".$page_count.">尾页</a>";                  //显示“尾页”超链接
							}
