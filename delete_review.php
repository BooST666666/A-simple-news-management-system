	...
	<div class="con_right">
		<div>
			<div class="blog_list_wrap">
				<div class="con_header"><div class="title"><span>您当前的位置：删除评论</span></div></div>
                ...
                <table class="table1">
					...
					<tr>
                        ...
                        <td align="center"><a href="delete_review_ok.php?id=<?php echo $row->news_id;?>&&review_qu=<?php echo $row->review_qu;?>&&state=<?php echo $row->state ?>&&user_name=<?php echo $row->user_name ?>&&publish_time=<?php echo $row->publish_time ?>&&content=<?php echo $row->content ?>"><img src="image/delete-bin-line.png"></a></td>
					</tr>
                    <?php
                      ...
                      <table style="width:100%; font-size:14px; border:0px;">
                        <tr>
                          <!--  翻页条 -->
							...
							echo  "<a href=delete_review.php?page=1 >首页</a>&nbsp;";        //显示“首页”超链接
							echo "<a href=delete_review.php?page=".($_GET['page']-1).">上一页</a>&nbsp;";      //显示“上一页”超链接
							}
							if($_GET['page']<$page_count){                                  //如果当前页不是尾页
							echo "<a href=delete_review.php?page=".($_GET['page']+1).">下一页</a>&nbsp;";       //显示“下一页”超链接
							echo "<a href=delete_review.php?page=".$page_count.">尾页</a>";                  //显示“尾页”超链接
							}
